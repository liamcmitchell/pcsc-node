...
/**
 * Represents a smart card reader (plain object from listReaders)
 ...
 * @property {(readerName: string, shareMode?: number, preferredProtocols?: number) => Promise<Card>} connect
