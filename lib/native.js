 ...
 * @property {string} reader - Reader name (or error message for "error" type)
 ...
 * @property {(shareMode?: number, preferredProtocols?: number, initialization?: number) => Promise<number>} reconnect
 */
